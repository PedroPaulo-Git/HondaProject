    ...
    <div id="ficha" className='my-20'>
        ...
        w-full h-52 sm:h-40 border-t-2 border-green-500
         bg-white flex justify-center text-center items-center '>
            ...
            rounded-full w-full max-w-sm flex justify-center items-center gap-1 sm:gap-4 ' target='blank' href="http://wa.me/5581999049803?text=Gostaria%20de%20entrar%20em%20contato%20!">
